namespace OpenCvSharp.Demo
{
	...
	public abstract class WebCamera: MonoBehaviour
	{
		...
		//	webCamDevice = WebCamTexture.devices[0];
            ...
            myrawimage.texture = webCamTexture;
            myrawimage.material.mainTexture = webCamTexture;
...
//            webCamTexture.Play();
        	...
        	Texture2D texture = new Texture2D(myrawimage.texture.width, myrawimage.texture.height, TextureFormat.ARGB32, false);
			...
			File.WriteAllBytes(Application.dataPath + "/testimg" + count + ".png", bytes);
			count ++;
			}
		}
